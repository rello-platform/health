...
export type EngineHealthResponse =
  | (BaseEngineHealth & { app: "milo-engine"; engineMetrics?: MiloEngineMetrics })
  | (BaseEngineHealth & { app: "content-engine"; engineMetrics?: ContentEngineMetrics })
  | (BaseEngineHealth & { app: "property-engine"; engineMetrics?: PropertyEngineMetrics })
  | (BaseEngineHealth & { app: "journey-engine"; engineMetrics?: JourneyEngineMetrics })
  | (BaseEngineHealth & { app: "report-engine"; engineMetrics?: ReportEngineMetrics })
  | (BaseEngineHealth & { app: "drumbeat-video-engine"; engineMetrics?: DVEMetrics });
